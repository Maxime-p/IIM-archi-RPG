...
const anecdotes: Anecdote[] = [
  {
    title:
      'Parti de Roissy, un Airbus d’Air France contraint de faire demi-tour après avoir déclenché un code de détresse',
    content: anecdote1,
  },
  {
    title:
      'Paris : Grâce aux passagers du RER D elle retrouve son portable dans la poche du voleur',
    content: anecdote2,
  },
  {
    title:
      'Morbihan : Une touriste se retrouve coincée dans la vase en voulant prendre des photos',
    content: anecdote3,
  },
]
