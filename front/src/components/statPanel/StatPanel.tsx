...
const StatPanel: React.FC = () => {
  ...
  const handleNameChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setInfos((prevState) => ({
      ...prevState,
      infos: { ...prevState.infos, name: newName },
    }))
  }
  ...
  const handleClearanceChange = (
    ...
    setInfos((prevState) => ({
      ...prevState,
      infos: { ...prevState.infos, clearance: newClearance },
    }))
  }
      ...
      <div>
        ...
        <div className="statPanel-body">
          <div className="statPanel-body__info">
            ...
            <input
              className="statPanel-body__info__value"
              type="text"
              onChange={handleNameChange}
              value={atom.infos.name}
            />
          </div>
          <div className="statPanel-body__info">
            ...
            <select
              ...
              defaultValue={atom.infos.profession}
            >
