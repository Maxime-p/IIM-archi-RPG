  ...
  return (
    <div className="statDetail-container">
      ...
      <p className="ps-count">
        {Math.round(
          (atom.adjectives.PHYSICAL.length + atom.adjectives.SOCIAL.length) /
            2 -
            0.5
        )}
      </p>
      <p className="sm-count">
        {Math.round(
          (atom.adjectives.SOCIAL.length + atom.adjectives.MENTAL.length) / 2 -
            0.5
        )}
      </p>
      <p className="mp-count">
        {Math.round(
          (atom.adjectives.MENTAL.length + atom.adjectives.PHYSICAL.length) /
            2 -
            0.5
        )}
      </p>
      <p className="pms-count">
        {Math.round(
          (atom.adjectives.PHYSICAL.length +
            atom.adjectives.SOCIAL.length +
            atom.adjectives.MENTAL.length) /
            3 -
            0.5
        )}
      </p>
